...
const Content = ({course, handleSelect}) => {
    ...
    return (
        <div className='p-4 bg-white rounded-[12px] space-y-4'>
            <div className='w-[280px] h-[144px] rounded-lg bg-gray-300'>
            ...
            <button onClick={()=>handleSelect(course)} className='btn w-[280px] h-10 bg-[#2F80ED] text-lg font-semibold rounded-lg text-white'>Select</button>
        </div>
    );
};
